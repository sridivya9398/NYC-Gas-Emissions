...
```{r echo=FALSE}
mergegas<-read.csv("C:/Users/reyha/Desktop/IDS Project/merged_data.csv")
...
```{r echo=FALSE}
degree1<-read.csv("C:/Users/reyha/Desktop/IDS Project/Average_Temperature_1900-2023.csv")
#str(degree1)
#head(degree1)
```
...
Please find the link to the dashboard here: **http://127.0.0.1:7029/**

Some screenshots of the dashboard are as followed:

```{r echo=FALSE, out.width='90%'}
knitr::include_graphics("C:/Users/reyha/Desktop/IDS Project/Screenshot (104).png")
...
```{r echo=FALSE, out.width='90%'}
knitr::include_graphics("C:/Users/reyha/Desktop/IDS Project/Screenshot (105).png")
```



```{r echo=FALSE, out.width='90%'}
knitr::include_graphics("C:/Users/reyha/Desktop/IDS Project/Screenshot (106).png")
```
